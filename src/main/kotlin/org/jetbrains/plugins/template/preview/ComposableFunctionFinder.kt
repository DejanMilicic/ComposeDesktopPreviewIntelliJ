 ...
 */
class ComposableFunctionFinder(private val classLoader: ClassLoader) {

    private val logger = Logger.getInstance(ComposableFunctionFinder::class.java)

    companion object {
        // Known Composable function signatures
        private val COMPOSABLE_ANNOTATIONS = setOf(
            "androidx.compose.runtime.Composable",
            "Composable" // Short name fallback
        )
...
//        }
     ...
     */
    private fun hasComposableAnnotation(method: Method): Boolean {
        return method.declaredAnnotations.any { annotation ->
    ...
    /**
     * Check if parameter is a Composer type
     */
    ...
    /**
     * Check if function is accessible (public or internal)
     */
